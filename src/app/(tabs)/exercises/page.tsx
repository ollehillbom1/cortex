  ...
  return (
    <div className="flex flex-col gap-5 pt-2">
              ...
              >
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1.5 text-xs text-[var(--color-ink-faint)]">
                    ...
                    {acc !== null && ` · recent ${Math.round(acc * 100)}%`}
                  </p>
                </div>
      ...
      <p className="text-xs leading-relaxed text-[var(--color-ink-faint)]">
        Levels adapt to keep each exercise challenging but doable. Scores reflect in-app performance
        only — they are not medical or IQ measurements.
      </p>
    </div>
  );
}
